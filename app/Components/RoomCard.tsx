...
//       <div className="flex gap-2 mb-1">
//         <Banknote size={20} />{" "}
//         <p className="font-inter text-sm"> Room internal?: {room.internal}</p>
//       </div>
//     </CardContent>
//     <CardFooter>
//       {/* Action Buttons */}
//       <div className="mt-0 gap-2 flex justify-between">
//         <Button onClick={() => onEdit(room.no)} variant="default">
//           <Pencil className="text-white" />
//         </Button>
//         <Button onClick={() => onDelete(room.no)} variant="destructive">
//           <Trash />
//         </Button>
//       </div>
//     </CardFooter>
